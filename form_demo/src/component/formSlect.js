...
export default function SelectForm () {
 ...
 return (
     ...
     <select value={car.branch} onChange={onchangeHandle} className="d-flex w-100">
     ...
     <textarea className="d-flex w-100"
         value={decripton}
     />
     </form>
     ...
     {pickedFile? (
         <div>
             ...
             <p>Last modified:{selectFile.lastModifiedDate.toLocaleDateString()}</p>
         </div>
     ) : (
